...
{
  memset(array,-1,5*1024*sizeof(size_t)); // Set the value of array to be -1, the size of array is 5*1024 and each unit is size_t
  maccess(array + 2*1024); // Why +2*1024
  sched_yield();
